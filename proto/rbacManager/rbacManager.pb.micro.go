...
type RbacManagerService interface {
	...
	ManagerUpdate(ctx context.Context, in *ManagerUpdateRequest, opts ...client.CallOption) (*ManagerUpdateResponse, error)
...
func (c *rbacManagerService) ManagerUpdate(ctx context.Context, in *ManagerUpdateRequest, opts ...client.CallOption) (*ManagerUpdateResponse, error) {
	req := c.c.NewRequest(c.name, "RbacManager.ManagerUpdate", in)
	out := new(ManagerUpdateResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type RbacManagerHandler interface {
	...
	ManagerUpdate(context.Context, *ManagerUpdateRequest, *ManagerUpdateResponse) error
...
func RegisterRbacManagerHandler(s server.Server, hdlr RbacManagerHandler, opts ...server.HandlerOption) error {
	type rbacManager interface {
		...
		ManagerUpdate(ctx context.Context, in *ManagerUpdateRequest, out *ManagerUpdateResponse) error
...
func (h *rbacManagerHandler) ManagerUpdate(ctx context.Context, in *ManagerUpdateRequest, out *ManagerUpdateResponse) error {
	return h.RbacManagerHandler.ManagerUpdate(ctx, in, out)
}
